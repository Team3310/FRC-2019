...
public class AutoTurn90CameraTrackWhenCrossYBoundary extends CommandGroup {
  /**
   * Add your docs here.
   */
  public AutoTurn90CameraTrackWhenCrossYBoundary(double yBoundaryForRightSideAuton, MovingYDirection movingDirection) {

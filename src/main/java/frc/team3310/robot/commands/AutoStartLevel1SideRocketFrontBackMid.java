...
public class AutoStartLevel1SideRocketFrontBackMid extends CommandGroup {
  /**
   * Add your docs here.
   */
  public AutoStartLevel1SideRocketFrontBackMid() {
    addParallel(new ElevatorSetPositionMM(Constants.HATCH_LEVEL_1));

    addParallel(new AutoCameraTrackWhenCrossXBoundary(160, MovingXDirection.Positive));
    addSequential(
        new DriveMotionCommand(TrajectoryGenerator.getInstance().getTrajectorySet().level1StartToRocketFront, true));

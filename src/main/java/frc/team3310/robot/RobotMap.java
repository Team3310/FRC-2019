...
public class RobotMap {
	...
	public static final int DRIVETRAIN_RIGHT_MOTOR3_CAN_ID = 2; // 4

	public static final int DRIVETRAIN_LEFT_MOTOR1_CAN_ID = 15;
	public static final int DRIVETRAIN_LEFT_MOTOR2_CAN_ID = 14;
	public static final int DRIVETRAIN_LEFT_MOTOR3_CAN_ID = 13; // 11

	public static final int ELEVATOR_MOTOR_1_CAN_ID = 3; // 2
	public static final int ELEVATOR_MOTOR_2_CAN_ID = 4; // 13
	public static final int ELEVATOR_MOTOR_3_CAN_ID = 5; // 12

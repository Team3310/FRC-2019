...
public class AutoStartLevel1RightSideRocketFrontBack extends CommandGroup {
  /**
   * Add your docs here.
   */
  public AutoStartLevel1RightSideRocketFrontBack() {
    ...
    addSequential(new DriveMotionCommand(
                    TrajectoryGenerator.getInstance().getTrajectorySet().loadingToRocketBackRight, false));
    // addParallel(new AutoCameraTrackWhenCrossXBoundary(268, MovingXDirection.Negative, 0.5, Constants.finishedAtRocketLimeY)); // 305
    // addSequential(new DriveMotionCommand(
    //                 TrajectoryGenerator.getInstance().getTrajectorySet().turn3ToRocketBackRight, false));
